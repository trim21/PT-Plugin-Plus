  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var noticeJsModalClassName = (exports.noticeJsModalClassName =
          "noticejs-modal");
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var AddModal = (exports.AddModal = function AddModal() {
          if (
            document.getElementsByClassName(API.noticeJsModalClassName)
              .length <= 0
          ) {
        ...
        var CloseItem = (exports.CloseItem = function CloseItem(item) {
          ...
          var position =
            "." +
            item.closest(".noticejs").className.replace("noticejs", "").trim();
          setTimeout(function () {
        ...
        var appendNoticeJs = (exports.appendNoticeJs = function appendNoticeJs(
          noticeJsHeader,
          noticeJsBody,
          noticeJsProgressBar,
        ) {
          ...
          if (options.newestOnTop === true) {
            document
              .querySelector(target_class)
              .insertAdjacentElement("afterbegin", noticeJsItem);
          } else {
            ...
            [
              {
                ...
                value: function show() {
                  ...
                  //Append NoticeJs
                  var noticeJs = helper.appendNoticeJs(
                    noticeJsHeader,
                    noticeJsBody,
                    noticeJsProgressBar,
                  );
