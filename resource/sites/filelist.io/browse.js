(function ($) {
  ...
  class App extends window.NexusPHPCommon {
    ...
    getDownloadURLs() {
      ...
      let links = $(
        "a[href*='download'][onclick!='return show_confirm();']",
      ).toArray();
    ...
    getDownloadURL(id) {
      return (
        `https://${PTService.site.host}/download.php?id=${id}` +
    ...
    confirmWhenExceedSize() {
      return this.confirmSize(
        $("div.visitedlinks").find(
          "div[class='torrenttable']:contains('MB'),div[class='torrenttable']:contains('GB'),div[class='torrenttable']:contains('TB')",
        ),
      );
    }
  }
